...
Check out the [demo](https://rafaalata.github.io/jsPDF-AutoTable/examples) to get an overview of what can be done with this plugin. Example uses include participant tables, start lists, result lists etc.
